#!/bin/bash
# ===========================================================
# 🚀 WSL Network Speed Booster v1.1 (Ubuntu)
...
# --- Step 1. Make sure /etc/wsl.conf disables auto resolv.conf generation ---
sudo tee /etc/wsl.conf >/dev/null <<'EOF'
[network]
generateResolvConf = false
EOF

# --- Step 2. Safely replace resolv.conf even if immutable ---
...
# --- Step 5. Generate PowerShell script in /mnt/c (writable) ---
PS_PATH="/mnt/c/Users/Public/wsl-tcp-opt.ps1"
sudo tee "$PS_PATH" >/dev/null <<'EOF'
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "$PS_PATH" || true
